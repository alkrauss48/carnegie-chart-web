<svelte:head>
	...
	<meta name="description" content="How the 30-Day Carnegie Chart works" />
</svelte:head>

<div class="text-column">
  <h2 class="text-5xl text-center my-8">How It Works</h2>
  ...
  <h2 class="text-3xl text-center my-4">About</h2>
	<p class="pb-4">
  ...
  <h2 class="text-3xl text-center my-4">Suggestions?</h2>
	<p class="pb-4">
    Hi, I'm Aaron. Want to add something to this chart? Feel free to shoot me an
    email with your suggestions at
    <a href="mailto:alkrauss48@gmail.com">alkrauss48@gmail.com</a>. Or, if you want to hack on to the site itself, checkout the
    <a target="_blank" href="https://github.com/alkrauss48/carnegie-chart-web">
      GitHub repo
    </a> and make a pull request.
  </p>
</div>
